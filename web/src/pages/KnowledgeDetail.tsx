        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2">
            <Card>
              ...
              <CardContent>
                {!currentKnowledgeBase.documents || currentKnowledgeBase.documents.length === 0 ? (
                  <div className="text-center py-8 text-gray-500">暂无文档，点击上方按钮上传</div>
                ) : (
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">
                              {(doc.fileSize / 1024).toFixed(2)} KB · {doc.chunkCount || 0} 个块
                            </p>
                          </div>
                        </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p>{new Date(currentKnowledgeBase.createdAt).toLocaleString()}</p>
                </div>
                <div>
